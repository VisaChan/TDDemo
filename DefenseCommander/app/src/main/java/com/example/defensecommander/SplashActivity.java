...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splash); //sets up a layout
        layout = findViewById(R.id.splashLayout); //grab an image
        ...
        //Alpha transition
        ImageView titleImage = findViewById(R.id.titleImage); //set up title
